...
<form action = "create_COUPs.php" method = "POST">
    ...
    <input type = "text" name = "payment_amount" placeholder = "Type payment amount"><br><br>
    <input type = "text" name = "coup_expr_date" placeholder = "Type coupon expiration date"><br>
    <input type = "text" name = "coup_amount" placeholder = "Type coupon amount"><br>
